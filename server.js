...
const BASE_URL = 'yourapp://ambulance'; // Add your app's deep link scheme here
    ...
    const notificationPromises = eligibleDrivers.map(async (driver) => {
      ...
      const message = {
        ...
        data: {
          ...
          serverUrl: SERVER_URL // Add the server URL to the notification payload
        },
        android: {
          priority: 'high',
          notification: {
...
const getServerUrl = () => {
  ...
  // For production, use the host without port if it's 80 or 443
...
app.get('/api/server-info', (req, res) => {
  const serverInfo = {
    ...
    version: '1.0.0', // You can set this from your package.json
    endpoints: {
